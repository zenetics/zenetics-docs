...
<Callout type="info" emoji="ℹ️">
  Managing environments is limited in the free pilot phase and you can request changes to the environment of your account by reaching out to our support team.
</Callout>
...
For example, a company in the area of customer service might create multiple applications to cover different use cases in their product:
...
<Callout type="info" emoji="ℹ️">
  Managing applications is limited in the free pilot phase and you can request changes to the applications of your account by reaching out to our support team. The feature for adding, deleting and modifying application will be available soon.
</Callout>
...
A session is the captured inputs and outputs of one or multiple calls to your selected LLM model and are automatically captured by the [Zenetics SDK](/sdk). An example is a multi-stage processing chain that includes steps to retrieve data and then generate content. 
